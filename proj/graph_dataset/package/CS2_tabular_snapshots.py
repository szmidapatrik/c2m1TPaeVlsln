...
class CS2_TabularSnapshots:
    ...
    def _TABULAR_refactor_player_columns(self, df):
        ...
        col_order = [
            ...
            'CT1_name', 'CT1_X', 'CT1_Y', 'CT1_Z', 'CT1_pitch', 'CT1_yaw', 'CT1_velocity_X', 'CT1_velocity_Y', 'CT1_velocity_Z', 'CT1_health', 'CT1_armor_value', 'CT1_active_weapon_magazine_size', 'CT1_active_weapon_ammo', 'CT1_active_weapon_magazine_ammo_left_%', 'CT1_active_weapon_max_ammo', 'CT1_total_ammo_left', 'CT1_active_weapon_total_ammo_left_%', 'CT1_flash_duration', 'CT1_balance', 'CT1_current_equip_value', 'CT1_round_start_equip_value', 
            ...
            'CT3_name', 'CT3_X', 'CT3_Y', 'CT3_Z', 'CT3_pitch', 'CT3_yaw', 'CT3_velocity_X', 'CT3_velocity_Y', 'CT3_velocity_Z', 'CT3_health', 'CT3_armor_value', 'CT3_active_weapon_magazine_size', 'CT3_active_weapon_ammo', 'CT3_active_weapon_magazine_ammo_left_%', 'CT3_active_weapon_max_ammo', 'CT3_total_ammo_left', 'CT3_active_weapon_total_ammo_left_%', 'CT3_flash_duration', 'CT3_balance', 'CT3_current_equip_value', 'CT3_round_start_equip_value', 
            ...
            'CT4_name', 'CT4_X', 'CT4_Y', 'CT4_Z', 'CT4_pitch', 'CT4_yaw', 'CT4_velocity_X', 'CT4_velocity_Y', 'CT4_velocity_Z', 'CT4_health', 'CT4_armor_value', 'CT4_active_weapon_magazine_size', 'CT4_active_weapon_ammo', 'CT4_active_weapon_magazine_ammo_left_%', 'CT4_active_weapon_max_ammo', 'CT4_total_ammo_left', 'CT4_active_weapon_total_ammo_left_%', 'CT4_flash_duration', 'CT4_balance', 'CT4_current_equip_value', 'CT4_round_start_equip_value', 
            ...
            'T5_name', 'T5_X', 'T5_Y', 'T5_Z', 'T5_pitch', 'T5_yaw', 'T5_velocity_X', 'T5_velocity_Y', 'T5_velocity_Z', 'T5_health', 'T5_armor_value', 'T5_active_weapon_magazine_size', 'T5_active_weapon_ammo', 'T5_active_weapon_magazine_ammo_left_%', 'T5_active_weapon_max_ammo', 'T5_total_ammo_left', 'T5_active_weapon_total_ammo_left_%', 'T5_flash_duration', 'T5_balance', 'T5_current_equip_value', 'T5_round_start_equip_value', 
            ...
            'T8_name', 'T8_X', 'T8_Y', 'T8_Z', 'T8_pitch', 'T8_yaw', 'T8_velocity_X', 'T8_velocity_Y', 'T8_velocity_Z', 'T8_health', 'T8_armor_value', 'T8_active_weapon_magazine_size', 'T8_active_weapon_ammo', 'T8_active_weapon_magazine_ammo_left_%', 'T8_active_weapon_max_ammo', 'T8_total_ammo_left', 'T8_active_weapon_total_ammo_left_%', 'T8_flash_duration', 'T8_balance', 'T8_current_equip_value', 'T8_round_start_equip_value', 
            ...
            'T9_name', 'T9_X', 'T9_Y', 'T9_Z', 'T9_pitch', 'T9_yaw', 'T9_velocity_X', 'T9_velocity_Y', 'T9_velocity_Z', 'T9_health', 'T9_armor_value', 'T9_active_weapon_magazine_size', 'T9_active_weapon_ammo', 'T9_active_weapon_magazine_ammo_left_%', 'T9_active_weapon_max_ammo', 'T9_total_ammo_left', 'T9_active_weapon_total_ammo_left_%', 'T9_flash_duration', 'T9_balance', 'T9_current_equip_value', 'T9_round_start_equip_value', 
