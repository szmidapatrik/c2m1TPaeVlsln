...
class CS2TabularSnapshots:
    ...
    def _TABULAR_refactor_player_columns(self, df):
        ...
        # Column order
        col_order = [
            'CT0_name', 'CT0_X', 'CT0_Y', 'CT0_Z', 'CT0_pitch', 'CT0_yaw', 'CT0_velocity_X', 'CT0_velocity_Y', 'CT0_velocity_Z', 'CT0_health', 'CT0_armor_value', 'CT0_active_weapon_ammo', 'CT0_total_ammo_left', 'CT0_is_alive',
